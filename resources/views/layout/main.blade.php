    ...
    <section class="row mb-4">
        ...
        <div class="col-sm-12">
            <div class="col-md-12">
                ...
                <!--<a href="#" class="active me-4">Tutte</a>
                <a href="#" class=" me-4">Personali</a>
                <a href="#">Professionali</a>-->
            </div>
        </div>
    </section>
    <section class="notes overflow-auto overflow-x-hidden">
        @yield('main-content')
    </section>
</main>
...
<script>
    setTimeout(() => {
        ...
        flash_message.style.display = 'none';}, 3000);
</script>
